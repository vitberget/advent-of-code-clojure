(ns year2020.day11.day11part2
  (:require [ysera.test :refer [is is= is-not]]
            [clojure.string :as str]))

(def ex-step-1 "L.LL.LL.LL\nLLLLLLL.LL\nL.L.L..L..\nLLLL.LL.LL\nL.LL.LL.LL\nL.LLLLL.LL\n..L.L.....\nLLLLLLLLLL\nL.LLLLLL.L\nL.LLLLL.LL")
(def ex-step-2 "#.##.##.##\n#######.##\n#.#.#..#..\n####.##.##\n#.##.##.##\n#.#####.##\n..#.#.....\n##########\n#.######.#\n#.#####.##")
(def ex-step-3 "#.LL.LL.L#\n#LLLLLL.LL\nL.L.L..L..\nLLLL.LL.LL\nL.LL.LL.LL\nL.LLLLL.LL\n..L.L.....\nLLLLLLLLL#\n#.LLLLLL.L\n#.LLLLL.L#")
(def ex-non-changing "#.L#.L#.L#\n#LLLLLL.LL\nL.L.L..#..\n##L#.#L.L#\nL.L#.LL.L#\n#.LLLL#.LL\n..#.L.....\nLLL###LLL#\n#.LLLLL#.L\n#.L#LL#.L#")
...
(defn find-seat
  [state seat [dx dy]]
  (loop [[sx sy] seat]
    (let [seat-pos [(+ sx dx) (+ sy dy)]
          seat-char (get state seat-pos)]
      (if-not (= \. seat-char)
        seat-char
        (recur seat-pos)))))
...
(defn day11part2
  {:test (fn [] (is= (day11part2 ex-step-1) 26))}
  [string]
  (->> string
       (string->state)
...
(comment
  (time (day11part2 puzzle))
  ;"Elapsed time: 5072.970542 msecs"
  ;=> 1955
  )
